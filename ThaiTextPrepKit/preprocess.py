...
def fix_common_word(x):
    ...
    x = re.sub(f'([ไใำ]ม[{vowel_typo}]*[ไใำ]ด[{vowel_typo}]*)|(มั[{vowel_typo}]*ย[ไใำ]ด[{vowel_typo}]*)|(มั[{vowel_typo}]*ยดั[{vowel_typo}]*ย)|(มั[{vowel_typo}]*ยด[{vowel_typo}]*าย)|(มั[{vowel_typo}]*ยดร[{vowel_typo}]*[า]*ย)|([ไใำ]ม[{vowel_typo}]*ด[{vowel_typo}]*าย)|([ไใำ]*ม[{vowel_typo}]*[ะ]*(ด[{vowel_typo}]*าย|ดร[{vowel_typo}]*[า]*ย|[ไใำ]ด[{vowel_typo}]*))|(บ่(ด[{vowel_typo}]*าย|ดร[{vowel_typo}]*[า]*ย|[ไใำ]ด[{vowel_typo}]*))', 'ไม่ได้', x)

...
def compile_patterns(patterns: list) -> list[re.Pattern]:
...
general_patterns = [
    ...
    #(re.compile(rf'(?<!<IGNORE>)(เบอ[ร]*[์]*โท[ร]*[สศ]ั[พบ][ท]*[์]*)|(?<!<IGNORE>)(เบอ[ร์]*โท[ร]*)|(?<!<IGNORE>)(เบอ(?!ะ)[ร]*[์]*)', re.IGNORECASE), 'หมายเลขโทรศัพท์'),
    #(re.compile(rf'(?<!<IGNORE>)((เบอ[ร]*[์]*โท[ร]*[สศ]ั[พบ][ท]*[์]*)|(เบอ[ร์]*โท[ร]*)|(เบอ(?!ะ)[ร]*[์]*))', re.IGNORECASE), 'หมายเลขโทรศัพท์'),
...
corp_patterns = [
    ...
    (re.compile(rf'(?<!<IGNORE>)(เบอ[ร]*[์]*โท[ร]*[สศ]ั[พบ][ท]*[์]*)', re.IGNORECASE), '<IGNORE>เบอร์โทรศัพท์</IGNORE>'),
    (re.compile(rf'(?<!<IGNORE>)(เบอ[ร]*[์]*โท[ร]*)', re.IGNORECASE), '<IGNORE>เบอร์โทร</IGNORE>'),
    (re.compile(rf'(?<!<IGNORE>)(เบอ[ร]*[์])', re.IGNORECASE), '<IGNORE>เบอร์</IGNORE>'),
]
...
patterns2 = corp_patterns + compile_patterns(gg) # corp_patterns + general_patterns + product_name_pattern + spec_general_patterns + drop_ignore_token
...
def fix_common_word(x):
    ...
    x = re.sub(f'(net|internet)|([อแิ][อิืฺ์ี]*[รนณฯญย][ดเ้][ทตมคจ][{vowel_typo}]*[แอิ]*[ร]*[ื์]*[ดเ้][รณนฯย][{vowel_typo}]*[คตจทม๖?])|(เน[{vowel_typo}]*[ตคจทม?๖][ื์]*[ตคจทม?๖]*[ื์]*)', 'อินเทอร์เน็ต', x)
    #x = re.sub(f'(เน[{vowel_typo}]*[ตคจทม?๖][ื์]*[ตคจทม?๖]*[ื์]*)', 'อินเทอร์เน็ต', x)

...
def fix_common_word(x):
    ...
    x = re.sub('(ๅ)', 'า', x)
    x = re.sub(f'(แอ[พปฟผ]*[พปฟผ]*ลิเคช[ัี]*[{vowel_typo}]น)|(แอ[{vowel_typo}]*[พปฟผฯ][ฯ]*(?!เปิ[{vowel_typo}]*ล))|(aplication|application|app(?![A-Za-z]))', 'แอปพลิเคชัน', x)
    ...
    #x = re.sub(r'\bpin(?![A-Za-z])', 'รหัสผ่าน', x)

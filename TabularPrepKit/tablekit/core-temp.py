...
def one_hot_encoder(df: pl.DataFrame, id_cols: str|list[str], column: str = 'decoded_label', separator: str = '_', rename_encoded_cols: bool = False) -> pl.DataFrame:
    ...
    return _rename_encoded_columns(q, column, separator) if rename_encoded_cols else q
...
def _rename_encoded_columns(df: pl.DataFrame, column: str, separator: str = '_') -> pl.DataFrame:
